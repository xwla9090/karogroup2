...
CORRECT_CONTENT = '''import { useEffect } from "react";
...
print("\n" + "="*55)
print("  کارۆ گروپ — RealtimeSync Fix 6")
print("="*55)
print("✅ FIX 1: setTimeout(3000) لابرا — ئێستا ڕاستەوخۆ")
print("✅ FIX 2: بەراورد لابرا — هەموو جار نوێ دەکرێتەوە")
print("✅ FIX 3: cash karoDataUpdate event زیاد کرا")
print("="*55)
print(f"\n✅ فایل پاشەکەوت کرا:\n   {FILE}")
print("\nئێستا ئەمەی خوارەوە بنووسە:")
print('  git add . && git commit -m "fix: realtime instant sync no delay" && git push')
