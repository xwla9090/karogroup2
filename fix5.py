...
print("\n" + "="*55)
print("  کارۆ گروپ — RealtimeSync Fix 5")
print("="*55)
print("✅ FIX 1: دووبارەی loansSub لابرا")
print("✅ FIX 2: RealtimeSync.js پاکیزە کرا")
print("="*55)
print(f"\n✅ فایل پاشەکەوت کرا:\n   {FILE}")
print("\nئێستا ئەمەی خوارەوە بنووسە:")
print('  git add . && git commit -m "fix: remove duplicate loansSub" && git push')
